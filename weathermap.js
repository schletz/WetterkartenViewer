...
var Weathermap = {
    ...
    getW3UrlGenerator: function (type, model, region) {
        if (region === undefined) { region = "025Grad"; }
        ...
        return function (time) {
            ...
            return "http://www1.wetter3.de/Animation_" + runParam + "_UTC" + regionParam + modelParam + "/" + timeParam + "_" + type + ".gif";
        };
    },
    ...
    getWetterNetUrlGenerator: function (type, region) {
        if (type === undefined) { type = "500hpa-bodendruck"; }
        if (region === undefined) { region = "eu"; }
        var runHour = Weathermap.lastRun.gfs.getUTCHours();
        var runParam = runHour < 10 ? "0" + runHour : runHour;
        return function (time) {
            return "http://www.wetter.net/profikarten/lauf" + runParam + "/" + type + "-" + region + "/images/" + type + "-" + region + "-" + time + ".gif";
        };
    },

    getWetterdataUrlGenerator: function (type) {
        if (type === undefined) { type = "34"; }
        var runHour = Weathermap.lastRun.gfs.getUTCHours();
        var runParam = runHour < 10 ? "0" + runHour : runHour;
        return function (time) {
            return "http://www.wetterdata.de/img/" + runParam + "UhrLauf/" + type + "_" + time + ".gif";
        };
    },
        ...
        return function (time) {
            if (time === 0) {
                return "http://weather.uwyo.edu/upperair/images/{$date}.11035.skewt.parc.gif".
                    replace("{$date}", lastTemp.getUTCymdh());
            }
...
Weathermap.initUi = function (container) {
    ...
    Weathermap.createPanels([
        ...
        [
            ...
            { start: 0, step: 3, stop: 240, layer: 4, urlGenerator: Weathermap.getTempsUrlGenerator() },
            { start: 252, step: 12, stop: 384, layer: 4, urlGenerator: Weathermap.getTempsUrlGenerator() }
        ...
        [
            ...
            { start: 0, step: 6, stop: 240, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("850temp") },
            { start: 252, step: 12, stop: 384, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("850temp") },

            { start: 0, step: 3, stop: 240, layer: 2, urlGenerator: Weathermap.getWzUrlGenerator(2, "GFSOPME") },
            ...
            { start: 0, step: 3, stop: 240, layer: 3, urlGenerator: Weathermap.getW3UrlGenerator(10, "GFS", "") },
            { start: 252, step: 12, stop: 384, layer: 3, urlGenerator: Weathermap.getW3UrlGenerator(10, "GFS", "") },


            /* ECMWF Anomaly und T850 */
            { start: 0, step: 24, stop: 240, layer: 4, urlGenerator: Weathermap.getWxcUrlGenerator("850temp_anom", "euratl", "ecmwf") },
        ...
        [
            ...
            */
            // WXCHARTS Overview Alps

            { start: 1, step: 1, stop: 102, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("overview", "alps", "arpege") },
            { start: 103, step: 1, stop: 120, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("overview", "alps") },
            { start: 123, step: 3, stop: 240, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("overview", "alps") },
            { start: 252, step: 12, stop: 384, layer: 1, urlGenerator: Weathermap.getWxcUrlGenerator("overview", "alps") },
            ...
            // Gesamtbewölkung
            { start: 3, step: 3, stop: 72, layer: 3, urlGenerator: Weathermap.getW3UrlGenerator(13, "ARPEGE", "025Grad") },
            { start: 78, step: 6, stop: 102, layer: 3, urlGenerator: Weathermap.getW3UrlGenerator(13, "ARPEGE", "025Grad") },
            { start: 105, step: 3, stop: 240, layer: 3, urlGenerator: Weathermap.getW3UrlGenerator(18, "GFS", "025Grad") },
            // W3 700 hpa Feuchtigkeit
            { start: 3, step: 3, stop: 240, layer: 4, urlGenerator: Weathermap.getW3UrlGenerator(2, "GFS", "025Grad") },
            // Akkumulierter Niederschlag
            { start: 6, step: 6, stop: 102, layer: 5, urlGenerator: Weathermap.getW3UrlGenerator(26, "ARPEGE", "025Grad") },
            { start: 108, step: 6, stop: 240, layer: 5, urlGenerator: Weathermap.getW3UrlGenerator(26, "GFS", "025Grad") },
        ...
        [
            ...
            */
            ...
            { start: 0, step: 3, stop: 240, layer: 2, urlGenerator: Weathermap.getWzUrlGenerator(3, "GFSOPME") },
